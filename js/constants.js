...
export const TIPOS_MENSAJE = {
    SISTEMA: {
        ...
        HEARTBEAT_START: 'SISTEMA.HEARTBEAT.START',
        HEARTBEAT_PAUSE: 'SISTEMA.HEARTBEAT.PAUSE',
        HEARTBEAT_ESTADO: 'SISTEMA.HEARTBEAT.ESTADO',
    ...
    NAVEGACION: {
        ...
        GPS: {
            ...
            SOLICITAR_UBICACION: 'NAVEGACION.GPS.SOLICITAR_UBICACION',
